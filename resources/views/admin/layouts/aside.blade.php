							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<div class="menu-content pt-8 pb-2">
										<span class="menu-section text-muted text-uppercase fs-8 ls-1">Jualan</span>
									</div>
								</div>
								<div class="menu-item">
								...
								<div class="menu-item">
									<a class="menu-link" href="#">
										...
										<span class="menu-title">Penghantaran</span>
									</a>
								</div>
								<div class="menu-item">
									<a class="menu-link" href="#">
										...
										<span class="menu-title">Invois</span>
									</a>
								</div>
								<div class="menu-item">
									<a class="menu-link" href="#">
								...
								<div class="menu-item">
									<div class="menu-content pt-8 pb-2">
										<span class="menu-section text-muted text-uppercase fs-8 ls-1">Katalog</span>
									</div>
								</div>
								<div class="menu-item">
								...
								<div class="menu-item">
									<a class="menu-link {{(request()->is('attribute')) ? 'active' : ''}}" href="{{route('attribute')}}">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotone/Code/Compiling.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
								...
								<div class="menu-item">
									<div class="menu-content pt-8 pb-2">
										<span class="menu-section text-muted text-uppercase fs-8 ls-1">Pelanggan</span>
									</div>
								</div>
								<div class="menu-item">
									<div class="menu-content pt-8 pb-2">
