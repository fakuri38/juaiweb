					...
					<div class="w-lg-500px bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						@csrf
							...
							<div class="text-center mb-10">
								<!--begin::Title-->
								<h1 class="text-dark mb-3">Log Masuk</h1>
								<!--end::Title-->
								<!--begin::Link-->
							...
							<div class="fv-row mb-10">
								<!--begin::Label-->
								<label class="form-label fs-6 fw-bolder text-dark">Emel</label>
								<!--end::Label-->
								<!--begin::Input-->
							...
							<div class="fv-row mb-10">
								...
								<div class="d-flex flex-stack mb-2">
									...
									<!--end::Label-->
									<!--begin::Link-->
									<a href="authentication/flows/basic/password-reset.html" class="link-primary fs-6 fw-bolder">Lupa Kata Laluan ?</a>
									<!--end::Link-->
								</div>
								<!--end::Wrapper-->
								<!--begin::Input-->
